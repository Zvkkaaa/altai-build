...
export const partners: Partner[] = [
  { name: "ХҮССЭН ЗҮГ ХХК", logo: "/partner-logos/hussen-zug.svg", featured: true },
  { name: "NBIK", logo: "/partner-logos/nbik.svg", featured: true },
  ...
  { name: "Bayan Airag", logo: "/partner-logos/bayan-airag.svg", featured: true },
  { name: "Oyu Tolgoi", logo: "/partner-logos/oyu-tolgoi.svg" },
  { name: "Jacobs", logo: "/partner-logos/jacobs.svg" },
  { name: "Хасу Мегаватт", logo: "/partner-logos/khasu-megawatt.svg" },
  { name: "Golomt Bank", logo: "/partner-logos/golomt-bank.svg" },
  { name: "Мандал Даатгал", logo: "/partner-logos/mandal.svg" },
  { name: "Samsung", logo: "/partner-logos/samsung.svg" },
  { name: "Monadelphous", logo: "/partner-logos/monadelphous.svg" },
  { name: "LG Hausys", logo: "/partner-logos/lg-hausys.svg" },
  { name: "Steppe Arena", logo: "/partner-logos/steppe-arena.svg" },
  { name: "Wave", logo: "/partner-logos/wave.svg" },
  { name: "Shangri-La", logo: "/partner-logos/shangri-la.svg" },
  { name: "Dayan Contract Mining", logo: "/partner-logos/dayan-contract-mining.svg" },
  { name: "Worley", logo: "/partner-logos/worley.svg" },
  { name: "Wagner CAT", logo: "/partner-logos/wagner-cat.svg" },
  { name: "Global Auto Rental", logo: "/partner-logos/global-auto-rental.svg" },
  { name: "Alimak", logo: "/partner-logos/alimak.svg" },
  { name: "Huawei", logo: "/partner-logos/huawei.svg" },
  { name: "MSM", logo: "/partner-logos/msm.svg" },
];
